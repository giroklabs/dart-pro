...
class InsightGenerator:
    ...
    def generate_daily_reports(self, target_date: str = None):
        ...
        for i, row in enumerate(targets):
            ...
            작성 지침:
            1. 절대 공시 원문의 기계적인 주석(예: 주1, 주2 등)이나 표 하단의 불필요한 부연 설명을 그대로 복사해서 붙여넣지 마세요.
            2. 이 공시가 기업의 향후 실적 및 주가 흐름에 미칠 단기/장기적 영향(호재·악재 여부)을 객관적으로 분석하세요.
            3. 계약 금액, 증자 규모 등 핵심 숫자가 있다면 전체 매출이나 기업 규모 대비 어느 정도 비중인지 그 의미를 쉽게 풀어 설명하세요.
            ...
            {{
                ...
                "summary": "공시 원문의 문장을 그대로 베끼지 말고, 투자 관점에서 가장 중요한 핵심(규모, 비중, 파급력 등)만을 3문장 이내로 명확하게 직접 작성하여 요약 (줄바꿈 없이)",
